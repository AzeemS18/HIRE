...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI learning recommendation system. Given the job role of a new hire and their identified skill gaps, you will provide personalized learning recommendations to address those gaps.
