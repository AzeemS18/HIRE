...
/**
 * @fileOverview Summarizes interview feedback to provide a quick overview of the candidate's performance.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an assistant helping recruiters by summarizing interview feedback.
